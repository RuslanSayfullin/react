...
summa_za_soputstv_uslugi = 116

nds_za_soputstv_uslugi=round(summa_za_soputstv_uslugi*20/120, 2)

print(nds_za_soputstv_uslugi)

nds_za_soputstv_uslugi_propisyu=num2text(nds_za_soputstv_uslugi)

print(nds_za_soputstv_uslugi_propisyu)